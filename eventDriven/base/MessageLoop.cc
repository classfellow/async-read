...
namespace base {
  ...
  MessagePumpForIO * MessageLoop::pump_io(){
    return static_cast<MessagePumpForIO*>(static_cast<MessagePumpWin*>(pump_.get()));
  }
  ...
  bool MessageLoop::LayerLoop::DoWork(){
    return false;
  }
  ...
  bool MessageLoop::LayerLoop::DoIdleWork(){
    return false;
  }

  void MessageLoop::LayerLoop::Run(){
    pump_->Run(NULL);
  }
  ...
  void MessageLoop::LayerLoop::PopBackLoop(){
    layer_.pop_back();
  }
