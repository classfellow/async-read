...
namespace base {
  ...
  bool Thread::CreateThreadInternal(size_t stack_size, Thread *thread, HANDLE *out_thread_handle){
    ...
    HANDLE thread_handle = (HANDLE)_beginthreadex(NULL, stack_size, ThreadFunc, params, flags, NULL);
